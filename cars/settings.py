...
SECRET_KEY = 'django-insecure-l9_f_dos4qeanxif)=$2#y*r5rxalj744vaq8b1k=ai=6n%&qy'
...
# В settings.py
LOGIN_URL = 'login'  # Убедитесь, что здесь указано правильное имя вашего маршрута входа
LOGIN_URL = '/login/'
...
MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'media'  # Или путь к вашей папке media
